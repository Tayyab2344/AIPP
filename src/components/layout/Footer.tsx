                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-wrap gap-5 text-stone-400">
                            <a href={SITE_CONFIG.social.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors" title="LinkedIn" aria-label="LinkedIn">
                                <Linkedin suppressHydrationWarning size={20} />
                            </a>
                            <a href={SITE_CONFIG.social.x} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors" title="X (Twitter)" aria-label="X (Twitter)">
                                <Twitter suppressHydrationWarning size={20} />
                            </a>
                            <a href={SITE_CONFIG.social.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors" title="Instagram" aria-label="Instagram">
                                <Instagram suppressHydrationWarning size={20} />
                            </a>
                            <a href={SITE_CONFIG.social.discord} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors" title="Discord" aria-label="Discord">
                            ...
                            <a href={SITE_CONFIG.social.substack} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--primary)] transition-colors" title="Substack" aria-label="Substack">
                                <svg suppressHydrationWarning width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-sm text-stone-300 font-medium">
                            ...
                            <div className="pt-4">
                                <Link href="/collaborate" className="inline-block bg-[var(--primary)] text-white px-6 py-2 text-xs font-bold uppercase tracking-widest rounded-sm">
                                    Join AIPP
                                </Link>
                            </div>
                        </div>
