    ...
    if (apiKey) {
      try {
        ...
        await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            from: 'AIPP <updates@resend.dev>', // Should be a verified domain in production
            to: email,
            subject: 'Welcome to the Athena Institute for Political Praxis',
            reply_to: 'Connect.aipp@gmail.com',
            html: `
        ...
        await fetch('https://api.resend.com/emails', {
          ...
          body: JSON.stringify({
            from: 'AIPP System <updates@resend.dev>',
        ...
        // We don't throw error here to ensure the user still sees a success message 
        // on the frontend since the subscriber was already added to the database.
      }
    } else {
