...
export async function POST(req: Request) {
    try {
        ...
        if (!apiKey) {
            console.warn('RESEND_API_KEY is missing. Collaboration emails skipped.');
            return NextResponse.json({ success: true, message: 'Institutional log created (Email skipped)' });
        }
        ...
        await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'AIPP Institutional <onboarding@resend.dev>',
                to: email,
        ...
        await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'AIPP System <onboarding@resend.dev>',
