        ...
        <div className="max-w-7xl mx-auto pb-12">
            ...
            <div className="mb-8 flex items-end justify-between">
                <div>
                    ...
                    <h1 className="text-4xl font-bold text-slate-900 font-serif">Articles & Insights</h1>
                    <p className="text-slate-500 mt-2 text-sm max-w-xl">
                        A centralized management system for editorial content, research summaries, and strategic awareness.
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    <button
                        onClick={handleExportSubscribers}
                        className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-4 py-2.5 rounded-lg hover:bg-slate-50 transition-colors font-bold text-[10px] uppercase tracking-widest"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 bg-[#2F4F4F] text-white px-5 py-2.5 rounded-lg hover:bg-[#1F3F3F] transition-all font-bold text-[10px] uppercase tracking-widest shadow-sm"
                    >
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            <select
                                ...
                                className="appearance-none bg-white border border-slate-200 rounded-lg px-4 py-2 text-xs font-bold uppercase tracking-widest focus:outline-none focus:border-[#2F4F4F] cursor-pointer pr-10"
                            >
                        ...
                        <div className="relative w-64">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-xs focus:outline-none focus:border-[#2F4F4F]"
                            />
                        </div>
                    </div>
