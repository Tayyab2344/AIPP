...
const PublicationsClient = ({ initialPublications }: PublicationsClientProps) => {
                        ...
                        <div>
                            ...
                            <RevealList className="space-y-12">
                                {publications.length > 0 ? publications.map((pub, i) => (
                                    <article key={pub.id || i} className="group grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-slate-100 last:border-0 items-start">
                                        {pub.imageUrl && (
